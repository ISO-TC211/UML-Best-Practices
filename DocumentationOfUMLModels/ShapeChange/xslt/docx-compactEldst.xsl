...
<xsl:stylesheet version="1.0" xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"
    ...
    <!-- Define the width (in percent [adding the '%' sign], for example 30% and 70%) for each of the columns in a feature type table. -->
    <xsl:variable name="ftypeTableColumnOneWidth">30%</xsl:variable>
    <xsl:variable name="ftypeTableColumnTwoWidth">70%</xsl:variable>

    <!-- Define the width (in percent [adding the '%' sign], for example 30% and 70%) for each of the columns in a class entry table (e.g. for enumeration values). -->
    <xsl:variable name="clentryTableColumnOneWidth">30%</xsl:variable>
    <xsl:variable name="clentryTableColumnTwoWidth">70%</xsl:variable>

    <!-- Define the width (in percent [adding the '%' sign], for example 30% and 70%) for each of the columns in a class entry table (e.g. for enumeration values). -->
    <xsl:variable name="entryTableColumnNameWidth">18%</xsl:variable>
    <xsl:variable name="entryTableColumnDefWidth">38%</xsl:variable>
    <xsl:variable name="entryTableColumnMultWidth">8%</xsl:variable>
    <xsl:variable name="entryTableColumnTypeWidth">18%</xsl:variable>
    <xsl:variable name="entryTableColumnRemarkWidth">18%</xsl:variable>
    ...
    <xsl:template
        match="/w:document/w:body/w:p[contains(w:r/w:t/text(),$DOCX_PLACEHOLDER) or contains(w:ins/w:r/w:t/text(),$DOCX_PLACEHOLDER)]">
